...
open class DatabaseManager {
    ...
    public func insertDatabaseSQL(tableName: String, columnAndValue: [(String, String)]) -> (success: Bool, mysqlResult: MySQL.Results?, errorMsg: String) {
        //这个函数返回一个元祖
        var columnStr = ""
        var valueStr = ""
...
//    public func insertDatabaseSQL(tableName: String, key: String, value: String) -> (success: Bool, mysqlResult: MySQL.Results?, errorMsg: String){
//        
